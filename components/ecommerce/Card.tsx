  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-md flex flex-col min-w-72 max-w-72 shrink-0">
      ...
      <div className="p-4 flex flex-col gap-2 flex-1">
        <p className="text-xs text-gray-700 dark:text-gray-400 font-open-sans">{location}</p>
        ...
        <div className="flex items-center justify-center gap-1">
          ...
          <span className="text-xs text-gray-700 dark:text-gray-400 font-open-sans ml-1">{rating} ({reviews})</span>
        </div>
