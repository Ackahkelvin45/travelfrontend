...
import footerBgDark from "../../assets/images/bgfooterdark.png";
import logofull from "../../assets/logo/logofull.png";
import logofulldark from "../../assets/logo/logofulldark.png";
...
export default function Footer() {
 ...
 return (
 <footer className="relative w-full font-open-sans mt-12 md:mt-25 overflow-hidden">
 {/* Background images — toggled by dark mode class */}
 <div className="absolute inset-0 bg-cover bg-center bg-no-repeat dark:hidden" style={{ backgroundImage: `url(${footerBg.src})` }} />
 <div className="absolute inset-0 bg-cover bg-center bg-no-repeat hidden dark:block" style={{ backgroundImage: `url(${footerBgDark.src})` }} />
 ...
 <Image src={logofull} alt="Azura Travels" className="w-48 h-auto dark:hidden" />
 <Image src={logofulldark} alt="Azura Travels" className="w-48 h-auto hidden dark:block" />
 ...
 {/* Instagram */}
 <a href="#" aria-label="Instagram" className="text-gray-700 dark:text-gray-300 hover:text-primary transition-colors">
 ...
 {/* Facebook */}
 <a href="#" aria-label="Facebook" className="text-gray-700 dark:text-gray-300 hover:text-primary transition-colors">
 <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
 <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
 </svg>
 </a>
 {/* Twitter / X */}
 <a href="#" aria-label="Twitter" className="text-gray-700 dark:text-gray-300 hover:text-primary transition-colors">
 <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
 <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
 </svg>
 </a>
 {/* LinkedIn */}
 <a href="#" aria-label="LinkedIn" className="text-gray-700 dark:text-gray-300 hover:text-primary transition-colors">
 <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
 ...
 <hr className="border-gray-200 dark:border-gray-700 mx-4 md:mx-10 lg:mx-20" />
 ...
 <div className="flex items-center border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden pr-1 bg-white dark:bg-gray-900 focus-within:border-primary transition-colors">
 <input
 type="email"
 value={email}
 ...
 required
 className="flex-1 px-4 py-3 text-sm text-gray-500 dark:text-gray-400 placeholder-gray-300 dark:placeholder-gray-500 outline-none bg-transparent"
 />
 <button 
 type="submit"
 disabled={isLoading}
 ...
 <p className="text-gray-700 dark:text-gray-300 text-xs font-open-sans">
 © {new Date().getFullYear()} Azuratravels. All rights reserved.
 </p>
 <div className="flex gap-6">
 <Link href="#" className="text-gray-700 dark:text-gray-300 text-xs hover:text-primary transition-colors">Privacy Policy</Link>
 <Link href="#" className="text-gray-700 dark:text-gray-300 text-xs hover:text-primary transition-colors">Terms of Service</Link>
 </div>
 </div>
