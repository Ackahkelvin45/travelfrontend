...
export default function HeroSearch() {
 ...
 className="text-sm text-gray-700 dark:text-gray-300 font-open-sans outline-none bg-transparent w-full placeholder-gray-400 dark:placeholder-gray-500 truncate"
 />
 </div>
 </div>
 ...
 className="text-sm text-gray-700 dark:text-gray-300 font-open-sans text-left truncate"
 >
 {dateLabel}
 </button>
 </div>
 ...
 {dateOpen && (
 <div className="absolute top-full left-0 w-full md:w-auto mt-2 bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-100 dark:border-gray-800 p-4 z-50 flex flex-col sm:flex-row gap-3">
 ...
 className="text-sm font-open-sans text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg px-2 py-1.5 outline-none focus:border-primary"
 />
 </div>
 <div className="flex flex-col gap-1">
 ...
 {typeOpen && (
 <div className="absolute top-full left-0 w-full md:w-auto md:min-w-[210px] mt-2 bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-100 dark:border-gray-800 py-2 z-50">
 {TOUR_TYPES.map((t) => (
 <button
 key={t.value}
 onClick={() => { setTourType(t.value); setTypeOpen(false); }}
 className={`w-full text-left px-4 py-2 text-sm font-open-sans hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-800 transition-colors ${
