...
export default function HeroSearch() {
 ...
 <span className="text-xs text-gray-500 font-open-sans">Where</span>
 <input
 type="text"
 value={where}
 ...
 className="text-sm text-gray-700 font-open-sans outline-none bg-transparent w-full placeholder-gray-400 truncate"
 />
 </div>
 </div>
 ...
 <div className="flex flex-col flex-1 min-w-0">
 <span className="text-xs text-gray-500 font-open-sans">When</span>
 <button
 ...
 <label className="text-xs text-gray-500 font-open-sans">From</label>
 <input
 type="date"
 value={fromDate}
 onChange={(e) => setFromDate(e.target.value)}
 className="text-sm font-open-sans text-gray-700 bg-white border border-gray-200 rounded-lg px-2 py-1.5 outline-none focus:border-primary"
 />
 </div>
 <div className="flex flex-col gap-1">
 <label className="text-xs text-gray-500 font-open-sans">To</label>
 <input
 type="date"
 value={toDate}
 min={fromDate}
 ...
 <div className="flex flex-col flex-1 min-w-0">
 <span className="text-xs text-gray-500 font-open-sans">Tour Type</span>
 <button
