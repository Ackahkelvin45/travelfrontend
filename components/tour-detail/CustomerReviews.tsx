...
function ReviewItem({ review }: { review: PackageReview }) {
 ...
 <p className="text-sm text-gray-700 dark:text-gray-300 font-open-sans leading-relaxed mb-3">
...
export default function CustomerReviews({ overallRating, totalReviews, categoryRatings, reviews }: CustomerReviewsProps) {
 ...
 <p className="text-xs text-gray-700 dark:text-gray-300 font-open-sans mt-1">Overall Rating · {totalReviews} reviews</p>
 </div>
 </div>
 ...
 <div key={cat.label}>
 <div className="flex justify-between text-xs font-open-sans text-gray-700 dark:text-gray-300 mb-1">
 <span>{cat.label}</span>
 ...
 <p className="text-sm text-gray-700 dark:text-gray-300 font-open-sans">No reviews yet. Be the first to leave one!</p>
 )}
