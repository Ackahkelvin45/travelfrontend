...
export default function LeaveReply({ packageId, bookingReference: initialBookingRef = "" }: LeaveReplyProps) {
 ...
 <p className="text-xs text-gray-700 dark:text-gray-300 font-open-sans mb-5">
 ...
 className="border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-2.5 text-sm font-open-sans text-text-primary bg-white dark:bg-gray-800 outline-none focus:border-primary transition-colors placeholder:text-gray-400 "
 ...
 className="border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-2.5 text-sm font-open-sans text-text-primary bg-white dark:bg-gray-800 outline-none focus:border-primary transition-colors resize-none placeholder:text-gray-400 "
