...
export default function LeaveReply({ packageId, bookingReference: initialBookingRef = "" }: LeaveReplyProps) {
 ...
 className="border border-gray-200 rounded-xl px-4 py-2.5 text-sm font-open-sans text-text-primary bg-white outline-none focus:border-primary transition-colors placeholder:text-gray-400 "
 ...
 className="border border-gray-200 rounded-xl px-4 py-2.5 text-sm font-open-sans text-text-primary bg-white outline-none focus:border-primary transition-colors resize-none placeholder:text-gray-400 "
