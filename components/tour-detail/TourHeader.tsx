...
export default function TourHeader({ title, badges, breadcrumb }: TourHeaderProps) {
 return (
 <div className="mb-4">
 <nav className="flex items-center gap-2 text-xs text-gray-700 font-open-sans mb-3">
 ...
 <button className="flex items-center gap-1.5 text-sm text-gray-700 font-open-sans hover:text-primary transition-colors">
